...
- `local/AppDatabase.kt` — singleton Room DB `marco_travel.db`, **version 7 with `fallbackToDestructiveMigration()`**. Any entity change wipes local data; bump `version` when you touch schema.
